...
namespace AirFlightsServer.SDK.Interfaces;
...
public interface IAirFlightsApiClient
{
    ...
    /// </summary>
    /// <returns></returns>
    Task<ApiResponseMessage<List<AirFlight>>> GetAirFlightsAsync();

    /// <summary>
    /// Get air flight by ID.
    /// </summary>
    /// <returns></returns>
    Task<ApiResponseMessage<AirFlight>> GetAirFlightAsync(Guid id);

    /// <summary>
    /// Create ir flight.
    /// </summary>
    /// <returns></returns>
    Task<ApiResponseMessage> CreateAirFlightAsync(AirFlight airFlight);

    /// <summary>
    /// Update air flight.
    /// </summary>
    /// <returns></returns>
    Task<ApiResponseMessage> UpdateAirFlightAsync(AirFlight airFlight);
